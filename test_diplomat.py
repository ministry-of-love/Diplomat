...
class TestDiplomat(object):
    ...
    def test_removetag(self, testbot):
        ...
        result = testbot.pop_message()
        # diplomat_plugin = plugin_manager.plugin_manager.get_plugin_obj_by_name('Diplomat')
        # assert 'spy' not in diplomat_plugin.diplomat['boneytooth thompkins isk-chip']['tags']
        # assert expected == result
    ...
    def test_remchar(self, testbot):
        ...
        result = testbot.pop_message()
        assert expected == result
        # diplomat_plugin = plugin_manager.get_plugin_obj_by_name('Diplomat')
        # assert 'boneytooth thompkins isk-chip' not in diplomat_plugin.diplomat
